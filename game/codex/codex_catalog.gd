	...
	match category:
		...
		2:
			result = [
				...
				{"name":"修复资源","tag":"局外资源","body":"完成探索或领取派遣成果获得。当前安全路线通关获得 7 点，全精英路线获得 9 点。\n\n用于解锁出发补给、基础体能、派遣功能、地点与后勤扩编，也用于支付派遣费用。\n\n探索资源在通关结算时带回；放弃未完成探索不会结算本局收入。"}]
		3:
		...
		4:
			result = [
				...
				{"name":"同学补给站 · 出发整备","tag":"补给事件","body":"终点前的整备机会。\n\n不需要战斗，从装备、训练或招募中选择一份奖励，为最终战斗做准备。"},
				{"name":"三选一构筑奖励","tag":"奖励规则","body":"战斗胜利或补给事件后，从三项奖励中选择一项。\n\n厚笔记本：获得生命装备；已有时改为守护者训练。\n专注训练：远射手本局生命 +50、攻击 +5。\n招募发明家：加入候补；已招募时改为发明家训练。\n\n训练可叠加，仅在本次探索有效。"}]
	return result
