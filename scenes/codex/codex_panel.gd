...
func _ready() -> void:
	...
	for state in ["normal","hover","pressed","focus"]:
		...
		style.bg_color = Color("dfbd76") if state != "pressed" else Color("aebc96")
		style.border_color = Color("253a36")
		style.set_border_width_all(3)
		theme_resource.set_stylebox(state,"Button",style)
	for state in ["font_color","font_hover_color","font_pressed_color","font_focus_color"]:
		theme_resource.set_color(state,"Button",Color("253a36"))
	theme = theme_resource
	var background = ColorRect.new()
	background.color = Color("253a36")
	...
	heading.add_theme_color_override("font_color",Color("253a36"))
	...
	detail.add_theme_color_override("default_color",Color("253a36"))
