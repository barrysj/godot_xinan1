"""Build Chalk Spirit candidate 004 from three generated RGB animation sheets.
...
def scale_consistency(all_records: dict[str, list[dict]]) -> dict:
    locomotion_height = median(record["region"][3] for record in all_records["locomotion"])
    combat_height = median(record["region"][3] for record in all_records["combat"])
...
def main() -> None:
    ...
    print("candidate 004: 44 poses, 7 clips")
