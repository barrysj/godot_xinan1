...
```text
docs/art/
  ART_CONTRACT.md       # 入口、职责与执行约束
  STYLE_BIBLE.md        # 总方向
  asset_manifest.yaml  # 实际资产登记
  specs/               # 角色、场景、UI 细则
  pipeline/            # 制作、评审、网页版备选
  prompts/             # 美术任务提示词
  tasks/               # 具体美术任务与阶段评审
    templates/         # 未批准的填写模板
```
...
正式图片留在 [assets/art/](../../assets/art/)，参考与候选留在 [design/](../../design/)。战斗动画的引擎资源、出手时序和验证入口见[战斗动画接入](../battle-animation.md)，不归入纯美术规范。
