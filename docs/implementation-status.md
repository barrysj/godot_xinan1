...
| E03 | [deployment_check.tscn](../scenes/battle_demo/deployment_check.tscn)，`--deployment-check` | PASS，failures=0；真实 Viewport 输入、点击立即部署／换人／换位、拖拽、部署菜单、撤回、部分部署恢复与下场沿用 | deploy |
...
| DEPLOY-01 | 部署 | 手牌点选／拖拽直接部署、换人、换位及撤回 | 已验证 | 快速调整阵容 | [deployment_panel.gd](../scenes/battle_demo/deployment_panel.gd) | [战斗](battle-demo.md) | E03、E04、E12 | 点击与拖拽均在选择有效目标后立即生效；首战空场、后续沿用；触控待验 |
